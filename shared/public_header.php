...
<html>
  <head>
    ...
    <title>System Analysis | <?php echo $page_title; //gets the $page_title from the page and puts it here ?></title>
      ...
      <div class="container">
        ...
        <nav>
          <ul>
            ...
            <li <?php if ($current == 'contract') {echo 'class="current"';} ?>><a href="<?php echo WWW_ROOT?>/reports/index.php">Reports</a></li>
